...
RISK_SCORE_ADDED_STATE_LEVEL_INFO_SEMANTICS_REPORT = int(
    os.environ.get('RISK_SCORE_ADDED_STATE_LEVEL_INFO_SEMANTICS_REPORT', 0))
...
RISK_SCORE_DELETED_STATE_LEVEL_INFO_SEMANTICS_REPORT = int(
    os.environ.get('RISK_SCORE_DELETED_STATE_LEVEL_INFO_SEMANTICS_REPORT', 0))
RISK_SCORE_DELETED_STATE_LEVEL_ERROR_SEMANTICS_REPORT = int(
    os.environ.get('RISK_SCORE_DELETED_STATE_LEVEL_ERROR_SEMANTICS_REPORT', 0))
RISK_SCORE_DELETED_STATE_LEVEL_INFO_SEMANTICS_FAULT = int(
    os.environ.get('RISK_SCORE_DELETED_STATE_LEVEL_INFO_SEMANTICS_FAULT', 0))
RISK_SCORE_DELETED_STATE_LEVEL_ERROR_SEMANTICS_FAULT = int(
    os.environ.get('RISK_SCORE_DELETED_STATE_LEVEL_ERROR_SEMANTICS_FAULT', 0))
