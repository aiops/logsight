...
RISK_SCORE_DELETED_STATE_LEVEL_ERROR_SEMANTICS_REPORT = int(
    os.environ.get('RISK_SCORE_DELETED_STATE_LEVEL_ERROR_SEMANTICS_REPORT', 25))
RISK_SCORE_DELETED_STATE_LEVEL_INFO_SEMANTICS_FAULT = int(
    os.environ.get('RISK_SCORE_DELETED_STATE_LEVEL_INFO_SEMANTICS_FAULT', 25))
RISK_SCORE_DELETED_STATE_LEVEL_ERROR_SEMANTICS_FAULT = int(
    os.environ.get('RISK_SCORE_DELETED_STATE_LEVEL_ERROR_SEMANTICS_FAULT', 25))
