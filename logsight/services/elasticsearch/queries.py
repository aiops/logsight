...
GET_ALL_AD = {
    ...
    "index": _index_placeholder, "body": {"query": {"bool": {"must": [{"range": {
...
GET_ALL_LOGS_INGEST = {"index": _index_placeholder, "body": {"query": {"bool": {
    "must": [{"range": {"ingest_timestamp": {"format": "strict_date_optional_time", "gt": _start_time_placeholder}}}],
    "filter": [{"match_all": {}}]}}}}

DELETE_BY_QUERY = {"index": '$index', "body": {"query": {"bool": {"must": [{"range": {
