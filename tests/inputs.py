...
incident_results = [{'timestamp': Timestamp("2021-12-16 05:16:00", freq='T'), 'total_score': 15,
                     ...
                     'semantic_ad': [[{'timestamp': Timestamp(
                         '2021-12-16 05:15:27.989000'), 'tags': "['default']",
                         'message': 'org.apache.hadoop.hdfs.server.datanode.DataNode: STARTUP_MSG:',
                         'level': 'INFO',
                         'template': '<*> <*>',
                         'prediction': 1}], [{
                         'timestamp': Timestamp(
                             '2021-12-16 05:15:35.447000'),
                         'tags': "['default']",
                         'message': 'org.apache.hadoop.hdfs.server.datanode.DataNode: registered UNIX signal handlers for [TERM, HUP, INT]',
                         'level': 'INFO',
                         'template': '<*> registered UNIX signal handlers for [TERM, HUP, INT]',
